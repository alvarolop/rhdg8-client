...
public class CacheController {
    ...
    public String health() {
        ...
        if (rcm.isStarted())
            return "SpringCache Manager is started! " + rcm.getConfiguration().toString() + System.lineSeparator();
        else
            return "SpringCache Manager is not started" + System.lineSeparator();
    }
...
*/
    ...
    public String getSingleString(HttpSession session,
            @PathVariable(value = "cache") String cacheName,
            @RequestParam(value = "key") int key) {
